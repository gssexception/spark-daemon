...
public class EmbeddedJetty {
    ...
    private static final String CONFIG_LOCATION_PACKAGE = "com.gss.config";
    private static final String MAPPING_URL = "/";
    private static final String WEBAPP_DIRECTORY = "E:/work/spark-daemon/src/main/webapp";
